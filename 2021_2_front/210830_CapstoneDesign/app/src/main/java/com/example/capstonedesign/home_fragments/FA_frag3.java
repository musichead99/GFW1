...
public class FA_frag3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        ...
        ToggleButton toggle_btn = rootView.findViewById(R.id.fa_frag3_toggleButton);
        boolean tf_period = toggle_btn.isChecked();
        float[] myData = new float[30];

        /** LineChart의 기본 세팅을 해주는 부분 **/
        LineChart lineChart = rootView.findViewById(R.id.fa_frag3_lineChart);
        ...
        int dataType = MyGoogleFit.TYPE_DISTANCE;
